    ...
    <LocaleProvider>
      <div>
        <div style={{ padding: 20 }}>
          <label style={{ display: "inline-block", width: 100, color: "white" }}>Date: </label>
          <DatePicker name="start" dateFormat={"Y-m-d H:i:S"} />
        </div>
        <div style={{ padding: 20 }}>
          <label style={{ display: "inline-block", width: 100, color: "white" }}>Enable Time: </label>
          <DatePicker name="start" enableTime dateFormat={"Y-m-d H:i:S"} />
        </div>
        <div style={{ padding: 20 }}>
          <label style={{ display: "inline-block", width: 100, color: "white" }}>Time Range: </label>
