...
As you [install Super Kubenetes on Kubernetes](../../installing-on-kubernetes/introduction/overview/), you can enable Super Kubenetes Events first in the [cluster-configuration.yaml](https://github.com/Super Kubenetes/ks-installer/releases/download/v3.3.0/cluster-configuration.yaml) file.
...
3. In **Custom Resources**, click <img src="/dist/assets/docs/v3.3/enable-pluggable-components/KubeSphere-events/three-dots.png" height="20px"> on the right of `ks-installer` and select **Edit YAML**.
...
5. You can use the web kubectl to check the installation process by executing the following command:
  ...
  <div className="notices note">
    <p>Note</p>
    <div>
      You can find the web kubectl tool by clicking <img src="/dist/assets/docs/v3.3/enable-pluggable-components/KubeSphere-events/hammer.png" height="20px"> in the lower-right corner of the console.
    </div>
  </div>
