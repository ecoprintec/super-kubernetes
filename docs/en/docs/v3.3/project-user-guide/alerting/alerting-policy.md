...
To edit an alerting policy after it is created, on the **Alerting Policies** page, click <img src="/dist/assets/docs/v3.3/project-user-guide/alerting/alerting-policies/edit-alerting-policy.png" height="20px" alt="icon"> on the right.
