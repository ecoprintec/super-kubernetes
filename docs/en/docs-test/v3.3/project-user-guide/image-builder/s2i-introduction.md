...
For more information about how to use S2I in Super Kubenetes, refer to [Source to Image: Publish an App without a Dockerfile](../source-to-image/). Besides, you can refer to the code repositories [S2IOperator](https://github.com/Super Kubenetes/s2ioperator#source-to-image-operator) and [S2IRun](https://github.com/Super Kubenetes/s2irun#s2irun) for more details.
