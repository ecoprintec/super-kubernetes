...
<div className="notices note">
  <p>Note</p>
  <div>
    The current Super Kubenetes version does not support grayscale release strategies for multi-cluster apps.
  </div>
</div>
