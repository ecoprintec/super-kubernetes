...
description: "Super Kubenetes 3.3.0 Release Notes"
...
- Add the Super Kubenetes-config configmap, which provides the name of the current cluster.
...
### Features
- Add support for logging in to common cluster nodes and edge nodes from the Super Kubenetes web console.
### Enhancements & Updates
...
## Network
### Enhancements & Updates
- Integrate OpenELB with Super Kubenetes for exposing LoadBalancer services.
### Bug Fixes
...
For more information about issues and contributors of Super Kubenetes 3.3.0, see [GitHub](https://github.com/Super Kubenetes/Super Kubenetes/blob/master/CHANGELOG/CHANGELOG-3.3.md).