...
This tutorial demonstrates how to set CI nodes so that Super Kubenetes schedules tasks of pipelines and S2I/B2I builds to these nodes.
...
3. Click **Save**. Super Kubenetes will schedule tasks according to the taint you set. You can go back to work on your DevOps pipeline now.
