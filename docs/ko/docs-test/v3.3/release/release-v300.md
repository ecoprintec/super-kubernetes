...
description: "Super Kubenetes release notes for 3.0.0."
...
- [Install Super Kubenetes v3.0.0 on Linux](../../installing-on-linux/)
- [Install Super Kubenetes v3.0.0 on existing Kubernetes](../../installing-on-kubernetes/)
...
- A brand-new installer: [KubeKey](https://github.com/Super Kubenetes/kubekey), v1.0.0, which is a turnkey solution to installing Kubernetes with Super Kubenetes on different platforms. It is more easy to use and reduces the dependency on OS environment

### UPGRADES & ENHANCEMENTS

- Be compatible with Kubernetes 1.15.x, 1.16.x, 1.17.x and 1.18.x for [ks-installer](https://github.com/Super Kubenetes/ks-installer), v3.0.0
- [KubeKey](https://github.com/Super Kubenetes/kubekey) officially supports Kubernetes 1.15.12, 1.16.13, 1.17.9 and 1.18.6 (Please avoid using KubeKey to install Kubernetes 1.15 to 1.15.5 and 1.16 to 1.16.2, because Kubernetes has an [API validation issue](https://github.com/kubernetes/kubernetes/issues/83778))
...
- Support custom monitoring for 3rd-party application metrics in Super Kubenetes console
- Add Kubernetes and Super Kubenetes auditing support, including audit event archiving, searching and alerting
- Add Kubernetes event management support, including Kubernetes event archiving, searching and alerting based by [kube-events](https://github.com/Super Kubenetes/kube-events)
...
- Add multi-tenant notification support by [Notification Manager](https://github.com/Super Kubenetes/notification-manager)
- Support Alertmanager v0.21.0

### UPGRADES & ENHANCEMENTS

- Upgrade Prometheus Operator to v0.38.3 (Super Kubenetes customized version )
...
- metrics-server is enabled by default (Disabled if Super Kubenetes is installed on existing Kubernetes)
...
- Fix time skew in metric graphs for newly created namespaces (#[2868](https://github.com/Super Kubenetes/Super Kubenetes/issues/2868))
- Fix workload-level alerting not working as expected (#[2834](https://github.com/Super Kubenetes/Super Kubenetes/issues/2834))
...
- Fix the issue that the Button in the Stage page doesn't work (#[449](https://github.com/Super Kubenetes/console/issues/449))
- Fix the issue that the parameterized pipeline failed to send the parameter's value (#[2699](https://github.com/Super Kubenetes/Super Kubenetes/issues/2699))
...
- Support pod security context (#[1453](https://github.com/Super Kubenetes/Super Kubenetes/issues/1453))
...
- Fix the error when editing ingress annotations (#[1931](https://github.com/Super Kubenetes/Super Kubenetes/issues/1931))
