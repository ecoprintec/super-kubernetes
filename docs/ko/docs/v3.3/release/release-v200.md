...
description: "Super Kubenetes release notes for 2.0.0."
linkTitle: "Release Notes - 2.0.0"
weight: 18900
---

Super Kubenetes 2.0.0 was released on **May 18th, 2019**. 
...
- Integrate [QingCloud Cloud Controller](https://github.com/yunify/qingcloud-cloud-controller-manager). After installing load balancer, QingCloud load balancer can be created through Super Kubenetes console and the backend workload is bound automatically.  
...
- Support [Source to Image](https://github.com/Super Kubenetes/s2ioperator) feature.
...
- [FluentBit Operator](https://github.com/Super Kubenetes/fluentbit-operator) supports logging gathering settings: ElasticSearch, Kafka and Fluentd can be added, activated or turned off as log collectors. Before sending to log collectors, you can configure filtering conditions for needed logs.
