...
module.exports = {
  ...
  ROLE_USERS_MANAGER: 'Manage all users on the Super Kubenetes platform.',
  ROLE_WORKSPACES_MANAGER: 'Manage all workspaces on the Super Kubenetes platform.',
  ROLE_PLATFORM_ADMIN: 'Manage all resources on the Super Kubenetes platform.',
