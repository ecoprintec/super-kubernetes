...
module.exports = {
  ...
  NO_CLUSTER_TIP_DESC: 'A cluster is a group of nodes (physical or virtual machines) running Super Kubenetes.',
  // List > Remove Cluster
  RISK_WARNING: 'Risk Warning',
  REMOVE_CLUSTER_TIP_A: 'After the cluster is removed, resources in the cluster will not be cleared automatically.',
  REMOVE_CLUSTER_TIP_B: 'After the cluster is removed, multi-cluster configuration data in the cluster will not be cleared automatically. Uninstalling Super Kubenetes or deleting related resources may cause user data loss. You must manually clear the multi-cluster configuration data in the removed cluster by refering to the <a href="https://kubesphere.io/docs/">official Super Kubenetes documentation</a>.',
