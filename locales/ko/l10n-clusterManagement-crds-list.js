...
module.exports = {
  ...
  CRD_PL: 'CRDs',
  CRD_LOW: 'CRD',
  CRD_DESC: '사용자 지정 리소스 정의(CRD)는 사용자가 모든 종류의 사용자 지정 리소스를 생성할 수 있도록 하여 Kubernetes를 확장합니다. 사용자는 이러한 CRD 개체를 기본 제공 리소스와 같이 사용할 수 있습니다.',
  // List
  CRD_EMPTY_DESC: 'CRD를 생성해주세요.',
  KIND_TCAP: '종류',
  SCOPE_TCAP: '범위'
};