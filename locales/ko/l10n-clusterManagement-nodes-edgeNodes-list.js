...
module.exports = {
  ...
  // List > Add
  ADD: '추가',
  ADD_EDGE_NODE: '엣지 노드 추가',
  EDGENODE_CONFIG_COMMAND: '엣지 노드 구성 명령',
  ADD_EDGE_COMMAND: '엣지 노드에서 위의 명령을 실행하여 구성합니다.' ,
  IN_USE_Node_IP: 'IP 주소 {ip}이(가) 사용 중입니다. 다른 IP 주소를 입력하십시오.' ,
  IN_USE_Node_NAME: '{name} 노드 이름이 이미 있습니다. 다른 이름을 입력하십시오.',
  EDGENODE_NAME_EMPTY_DESC: '엣지 노드의 이름을 설정하십시오.' ,
  EDGENODE_CONFIG_COMMAND_TIP: '명령을 실행하기 전에 Docker 또는 containerd와 같은 컨테이너 런타임 파일을 에지 노드에 설치해야 합니다. <a href="https://kubeedge.io/en/docs/" target="_blank">자세히 알아보기 </a>',
