...
module.exports = {
  ...
  CLUSTER_ENABLE_GATEWAY_DESC: '클러스터 게이트웨이를 사용하도록 설정하십시오.' ,
  CLUSTER_GATEWAY: '클러스터 게이트웨이',
  GATEWAY_ADDRESS_SCAP: '게이트웨이 주소',
  LOAD_BALANCER_PROVIDER_SCAP: '로드 밸런서 공급자',
  // Cluster Gateway > Enable Gateway
  ENABLE_GATEWAY: '게이트웨이 활성화',
  GATEWAY_TRACING_TIP: '<b>추적</b>이 활성화된 후 경로에 액세스할 수 없으면 경로에 <b>nginx.ingress.kubernetes.io/service-upstream: true </b> 주석을 추가하십시오.',
  // Cluster Gateway > Manage > View Details
  VIEW_DETAILS: '세부 정보보기',
  // Cluster Gateway > Manage > Disable
  DISABLE: '비활성화',
  DISABLE_GATEWAY: '게이트웨이 비활성화',
  DISABLE_GATEWAY_TIP: '게이트웨이를 비활성화하시겠습니까?',
  DISABLE_SUCCESSFUL: '비활성화되었습니다.',
  // Cluster Gateway > Manage > Edit
  EDIT: '수정',
  EDIT_TITLE: '{title} 수정',
  // Cluster Gateway > Manage > Update
  UPDATE: '업데이트',
  UPDATE_GATEWAY_DESC: '이 작업은 잠시 동안 비즈니스를 방해할 수 있습니다. 이 작업을 수행할 때 주의하십시오.',
  // Project Gateways
  PROJECT_GATEWAY_PL: '프로젝트 게이트웨이',
  PROJECT_GATEWAY_NOT_ENABLED: '프로젝트 게이트웨이가 활성화되지 않음',
  PROJECT_ENABLE_GATEWAY_DESC: '프로젝트 게이트웨이를 활성화하십시오.',
  REPLICA_COUNT: '복제본',
  NODE_PORTS: '노드 포트',
  UPDATE_GATEWAY_DESC: '현재 게이트웨이를 업데이트할 수 있습니다.',
  // Project Gateways > Disable
  PROJECT_GATEWAY_LOW: '프로젝트 게이트웨이',
  DISABLE_MULTIPLE_GATEWAYS: '다중 게이트웨이 비활성화'
};