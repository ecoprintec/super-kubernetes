 ...
 */
module.exports = {
  "CUSTOM_RESOURCE_PL": "사용자 정의 리소스",
  "PROJECT_DEVOPS_PROJECT": "프로젝트/DevOps 프로젝트",
  "CUSTOM_RESOURCE": "사용자 정의 리소스",
  "CUSTOM_RESOURCE_DEFINITION_LOW": "사용자 리소스 정의",
  "CUSTOM_RESOURCE_LOW": "사용자 정의 리소스"
}