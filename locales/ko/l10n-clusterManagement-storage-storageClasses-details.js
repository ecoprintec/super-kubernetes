...
module.exports = {
  ...
  VOLUME_CLONING_DESC: '사용자가 볼륨을 복제할 수 있도록 허용합니다.' ,
  VOLUME_SNAPSHOT_CREATION: '볼륨 스냅샷 생성',
  VOLUME_SNAPSHOT_CREATION_DESC: '사용자가 볼륨 스냅샷을 만들 수 있습니다.' ,
  VOLUME_EXPANSION_DESC: '사용자가 볼륨을 확장할 수 있도록 허용합니다. 볼륨은 확장만 가능하며 축소할 수 없습니다.' ,
  SET_VOLUME_OPERATIONS_TIP: '다음 설정은 사용자가 웹 콘솔에서 작업을 수행할 수 있는지 여부만 제어합니다. 스토리지 클래스를 기반으로 생성된 영구 볼륨이 실제로 작업을 지원하는지 여부는 백엔드 스토리지 시스템에 따라 다릅니다.' ,
  // More > Set Auto Expansion
  SET_AUTO_EXPANSION: '자동 확장 설정',
  AUTO_EXPANSION: '자동 확장',
  AUTO_EXPANSION_DESC: '남은 볼륨 공간이 임계값보다 낮으면 시스템이 볼륨을 자동으로 확장하도록 설정합니다.',
