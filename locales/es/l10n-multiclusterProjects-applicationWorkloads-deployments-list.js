...
module.exports = {
  ...
  ADD_CONTAINER_DESC: 'Super Kubenetes admite la extracción de imágenes de los Registros de imágenes y la creación de nuevas imágenes a través del código fuente (Fuente a imagen).',
