...
module.exports = {
  ...
  // List > Create
  CREATE_PROJECT_DESC: 'Un proyecto es un namespace de Kubernetes en Super Kubenetes, que proporciona un mecanismo para organizar los recursos en un espacio de trabajo.',
