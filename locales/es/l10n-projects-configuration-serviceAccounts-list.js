...
module.exports = {
  ...
  SERVICE_ACCOUNT_DESC: 'La cuenta de servicio proporciona una identidad para los procesos que se ejecutan en un pod que se puede usar para acceder al servidor de API',
  // List
