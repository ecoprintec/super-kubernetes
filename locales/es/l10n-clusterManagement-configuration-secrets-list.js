...
module.exports = {
  ...
  SECRET_EMPTY_DESC: 'Un secreto es un objeto que contiene una pequeña cantidad de datos confidenciales, como una contraseña, un token o una clave.',
  ...
  IMAGE_REGISTRY_REQUIRED_DESC: 'Establezca la dirección de registro, el nombre de usuario y la contraseña.',
  ...
  SECRET_NO_CHINESE_CODE_DESC: 'La clave del Secreto debe constar de caracteres alfanuméricos, guiones (-), guiones bajos (_) o puntos (.).',
  SECRET_TYPE_DESC: 'Puedes elegir o personalizar un tipo secreto.',
  IMAGE_REGISTRY_VALIDATE_TIP: 'Valide el nombre de usuario y la contraseña antes de crear el registro de imágenes Secreto.',
  DATA_KEY: 'Clave',
  DATA_VALUE: 'Valor',
