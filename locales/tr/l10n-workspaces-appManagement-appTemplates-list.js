...
module.exports = {
  ...
  APP_STATUS_DRAFT: 'Yayınlanmamış',
  APP_STATUS_SUSPENDING: 'Askıya alındı',
  ...
  UPLOAD_HELM_CHART_DESC: 'Varolan bir Helm çizelgesi yükle.',
  HELM_CHART_FORMAT_DESC: 'tar.gz ve tgz biçimlerini destekler.',
  UPLOAD_ICON: 'Ikon Yükle',
  UPLOAD_SUCCESSFUL: 'Başarıyla yüklendi.',
  UPLOADING: 'Karşıya yükleniyor',
  FILE_MAX_SIZE_ICON: 'Ikon için maksimum boyut 96 x 96 pikseldir.',
  FILE_MAX_SCREENSHOTS: 'Snapshot boyutu 2 MB\'ı geçemez.',
  APP_ICON_NOTE: '96 x 96 piksel boyutunda bir JPG veya PNG imgesi yükle.',
  MISS_FILE_NOTE: '{file} dosyası bulunamadı.',
  LICENSE_FILE_DESC: 'Metin formatındaki lisans anlaşması.',
  CHART_FILE_DESC: 'Çizelge hakkında isim ve sürüm gibi temel bilgileri tanımlayan YAML dosyası.',
  README_FILE_DESC: 'Uygulama girizgahı.',
  REQUIREMENTS_FILE_DESC: 'Çizelgenin bağımlılıklarını tanımlayan dosya.',
  VALUES_FILE_DESC: 'Çizelgenin varsayılan konfigürasyon dosyası.',
  CHARTS_FILE_DESC: 'Çizelgenin bağımlılıklarını içeren klasör.',
  TEMPLATES_FILE_DESC: 'Dağıtım şablon dosyalarını içeren klasör.',
  NOTES_FILE_DESC: 'Kullanıcı yönergeleri.',
  INCORRECT_FILE: 'Yanlış dosya? ',
  TRY_AGAIN: 'Tekrar Deneyin',
  FILE_MAX_ICON_DESC: 'Ikon boyutu 20 KB\'ı geçmemelidir. Lütfen tekrar deneyin.',
  HOMEPAGE: 'Anasayfa',
