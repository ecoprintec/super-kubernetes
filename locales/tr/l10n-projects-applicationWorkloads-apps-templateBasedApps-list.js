...
module.exports = {
  ...
  APPLICATIONS_DESC: 'Bir uygulama, kullanıcılara tek bir pakette kapsamlı iş işlevleri sağlar. Super Kubenetes\'deki uygulama şablonları, Helm paketleme spesifikasyonuna göre oluşturulmuştur. Birleşik bir genel veya özel Helm deposu aracılığıyla teslim edilirler. Bir uygulama, iş yükleri, hizmetler ve girişler dahil olmak üzere bir veya daha fazla Kubernetes nesnesinden oluşur.',
  APP_PL: 'Uygulamalar',
  APP_TYPES_Q: 'Super Kubenetes hangi uygulama türlerini destekler?',
  APP_TYPES_A: 'Super Kubenetes, şablon tabanlı uygulamaları ve oluşturulmuş uygulamaları destekler. Şablon tabanlı uygulamalar şuradan oluşturulur: Uygulamaları Super Kubenetes App Store\'dan veya bir uygulama şablonundan dağıtabilirsiniz. Oluşturulan uygulamalar kullanıcılar tarafından özelleştirilir.',
  ...
  TEMPLATE_BASED_APP_EMPTY_DESC: 'Lütfen Super Kubenetes App Store\'dan bir uygulama veya bir uygulama şablonu oluşturun.',
  APP: 'Uygulama',
  VERSION: 'Versiyon',
  ...
  CREATE_APP_DESC: 'Super Kubenetes App Store\'dan veya bir uygulama şablonundan bir uygulama oluşturun.',
  FROM_APP_STORE: 'Uygulama Mağazasından',
  FROM_APP_TEMPLATE: 'Uygulama Şablonundan',
  FROM_APP_STORE_DESC: 'Super Kubenetes App Store\'dan bir uygulama oluşturun.',
