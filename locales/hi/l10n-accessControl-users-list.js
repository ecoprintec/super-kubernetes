...
module.exports = {
  ...
  PLATFORM_ROLE_DESC: 'Super Kubenetes प्लेटफॉर्म पर उपयोगकर्ता की भूमिका निर्धारित करें।',
  USER_SETTING_EMAIL_DESC: 'ईमेल पते का उपयोग Super Kubenetes वेब कंसोल में लॉग इन करने के लिए किया जा सकता है।',
