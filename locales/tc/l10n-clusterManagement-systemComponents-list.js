...
module.exports = {
  ...
  SERVICE_COMPONENTS_DESC: '服務組件提供 Super Kubenetes、Kubernetes 和 OpenPitrix 集群内各項服務組件的健康狀態監控，可以查看目前集群的健康狀態和運行時間，能夠幫助用戶監測集群的狀況和即時定位問題。',
  // Super Kubenetes
  STOPPED: 'Stopped',
  RUNNING_TIME: '運行時間',
  KS_CONSOLE_DESC: '提供 Super Kubenetes 的控制台服務',
  ...
  KUBE_STATE_METRICS_DESC: '監聽 Kubernetes API server 以獲取集群中各種 API 對象的狀態包括節點，工作負載和 Pod 等，並生成相關監控數據供 Prometheus 抓取',
  ...
  NOTIFICATION_MANAGER_SVC_DESC: 'Notification Manager 服務，提供發送郵件、微信、Slack 等通知的接口',
  NOTIFICATION_MANAGER_CONTROLLER_METRICS_DESC: '提供 Notification Manager Controller 内部監控數據的服務',
  // Logging
  LOGGING: '紀錄',
