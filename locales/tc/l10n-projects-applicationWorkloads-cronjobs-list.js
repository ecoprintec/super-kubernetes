...
module.exports = {
  ...
  CRONJOB_CRON_DESC: 'Set a schedule for the CronJob. Super Kubenetes uses UTC by default and you need to adjust the schedule according to your time zone. <a href="//en.wikipedia.org/wiki/Cron" target="_blank">Learn More</a>',
  ...
  MAXIMUM_DELAY_DESC: 'Deadline for starting the Job if the scheduled run is missed for any reason.',
  ...
  COMPLETE_PODS_DESC: 'Number of Pods that complete successfully required for the Job to be marked as complete.',
  MAXIMUM_DURATION_DESC: 'Maximum duration of the Job. The Job is terminated when it reaches the specified deadline.',
  PARALLEL_PODS: '並行數',
  COMPLETE_PODS: '完成數',
